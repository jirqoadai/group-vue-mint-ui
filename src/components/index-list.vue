<template>
  <div class="page-indexlist">
    ...
    <div class="page-indexlist-wrapper">
      <mt-index-list>
        <mt-index-section v-for="item in alphabet" :index="item.initial" v-bind:key="item.index">
          <mt-cell v-for="cell in item.cells" :title="cell" v-bind:key="cell.index"></mt-cell>
        </mt-index-section>
      </mt-index-list>
    </div>
  </div>
