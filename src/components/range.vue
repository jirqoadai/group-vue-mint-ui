<template>
  <div class="page-range">
    ...
    <mt-cell v-for="item in cells1" :title="item.title" :label="'value:' + item.value" v-bind:key="item.index">
    ...
    <mt-cell v-for="item in cells2" :title="item.title" :label="'value:' + item.value" v-bind:key="item.index">
    ...
    <mt-cell v-for="item in cells3" :title="item.title" :label="'value:' + item.value" v-bind:key="item.index">
